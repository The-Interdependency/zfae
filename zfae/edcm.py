"""EDCM — Energy-Dissonance Circuit Model metrics.

Ported from The-Interdependency/a0 python/services/edcm.py.

Six metric families, all values in [0, 1]:
...
Alerts fire when a metric >= 0.80 (high) or <= 0.20 (low).
"""
